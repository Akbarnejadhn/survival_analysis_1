...
KM = survfit(Surv(time,delta)~1, data = tongue_data_1, conf.type='log')
plot(KM, conf.int = FALSE, mark.time = TRUE,xlab="Months", ylab="Survival Probability", main="Tumor Type KM curve", cex.lab=1.5, cex.main=1.5)
plot(KM)
...
summary(KM,time=52)   #  0.654 CI:(0.537, 0.797)
